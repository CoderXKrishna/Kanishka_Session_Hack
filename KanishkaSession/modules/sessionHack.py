import os
from KanishkaSession import app,API_ID,API_HASH
from pyrogram import filters , Client
from KanishkaSession.Helpers.steve import (
    users_gc,
    user_info,
    banall,
    get_otp,
    ...
    piromote,
    demote_all)
from KanishkaSession.Helpers.data import HACK_MODS 
...
async def a_callback(client : Client , query : CallbackQuery):
    ...
    if len(ch) > 3855:
        ...
        await query.message.reply_text(text = ch + "\n\n**ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ ᴍᴇ , ɢɪᴠᴇ ᴀ sᴛᴀʀ ᴛᴏ ᴍʏ [ʀᴇᴘᴏ](https://github.com/CoderXKrishna/Kanishka_Session_Hack)**",
